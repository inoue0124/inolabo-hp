...
const expImg = require("../../../static/images/worksExperiment.png")
const chitaiImg = require("../../../static/images/worksChintai.png")
const talkativeImg = require("../../../static/images/solutionLanguage.png")
        ...
        <Grid container justify="center" spacing={10}>
          <Grid item xs={12} md={4} alignContent="center">
            <WorksCard
              title="実験作成・管理システム"
              platform="Web"
              technology="Nuxt.js, Ruby on Rails, AWS"
              image={expImg}
            />
          </Grid>
          <Grid item xs={12} md={4} alignContent="center">
